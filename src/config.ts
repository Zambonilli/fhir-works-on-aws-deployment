...
const dynamoDbDataService = new DynamoDbDataService(DynamoDb, true, ttlsInSeconds);
const dynamoDbBundleService = new DynamoDbBundleService(DynamoDb, true, undefined, ttlsInSeconds);
